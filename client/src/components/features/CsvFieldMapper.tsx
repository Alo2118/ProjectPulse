  ...
  return (
    <div className="space-y-2">
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">
        ...
        <span className="font-medium text-gray-700 dark:text-gray-300">"Ignora"</span> verranno
        saltati.
      </p>
      ...
      <div className="divide-y divide-gray-100 dark:divide-gray-700/50 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
        {/* Header row */}
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3 px-4 py-2 bg-gray-50 dark:bg-gray-800/50 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">
          ...
          return (
            ...
            >
              ...
              <div
                ...
                title={header}
              >
                <span className="inline-flex items-center px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-700 font-mono text-xs">
                  {header}
                </span>
              </div>
              ...
              <ArrowRight
                className={`w-4 h-4 flex-shrink-0 ${
                  isMapped ? 'text-primary-500' : 'text-gray-300 dark:text-gray-600'
                }`}
              />
