...
export function TimerWidget({ onTimerToggle }: TimerWidgetProps) {
  ...
  return (
    <div className="card p-4 sm:p-6 border-cyan-500/30 dark:border-cyan-500/40 bg-gradient-to-r from-cyan-50/50 to-transparent dark:from-cyan-900/20 dark:to-transparent">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <Link
            ...
            className="text-base sm:text-lg font-semibold text-slate-900 dark:text-white hover:text-cyan-600 dark:hover:text-cyan-400 truncate block"
          >
