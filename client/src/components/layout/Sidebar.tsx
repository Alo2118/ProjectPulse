...
const navigation = [
  ...
  { name: 'Time Tracking', href: '/time-tracking', icon: Clock, roles: ['admin', 'dipendente'] },
  ...
  { name: 'Impostazioni', href: '/settings', icon: Settings, roles: ['admin'] },
]
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-white/70 dark:bg-surface-900/90 backdrop-blur-xl border-r border-white/20 dark:border-white/5 hidden lg:block">
      <div className="flex flex-col h-full">
        {/* Logo */}
        <div className="flex items-center h-16 px-6 border-b border-gray-200/30 dark:border-white/5">
