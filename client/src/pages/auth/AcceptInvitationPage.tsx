...
export default function AcceptInvitationPage() {
  ...
  if (acceptInvitation.isSuccess) {
    return (
      <div className="flex min-h-screen items-center justify-center p-4" style={{ background: "var(--bg-base)" }}>
        <Card className="w-full max-w-md" style={{ background: "var(--bg-surface)", borderColor: "var(--border-default)" }}>
